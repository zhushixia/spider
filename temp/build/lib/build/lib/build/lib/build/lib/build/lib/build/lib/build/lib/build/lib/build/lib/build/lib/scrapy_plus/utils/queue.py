...
from scrapy_plus.conf.settings import REDIS_QUEUE_DB, REDIS_QUEUE_HOST, REDIS_QUEUE_PORT, REDIS_QUEUE_NAME
...
class Queue(object):
    ...
    Full = BaseQueue.Full
    max_timeout = 0.3
# s = redis.StrictRedis(host="192.168.80.157", port=6379, db=0)
